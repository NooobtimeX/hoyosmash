    ...
    <div className="relative py-4">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-5 lg:px-5">
        <div className="grid w-full grid-cols-1 items-center justify-start gap-12 lg:grid-cols-2">
          <div className="order-last m-auto grid w-full max-w-96 grid-cols-2 items-start justify-center gap-3 sm:grid-cols-2 lg:order-first">
          ...
          <div className="m-auto inline-flex w-full flex-col items-center justify-center gap-10 lg:items-start">
